...
- Em pedidos de prompts (imagem/música/design), enviar cada prompt em mensagem separada no WhatsApp; cada mensagem de prompt deve vir sozinha em bloco de código, sem texto extra. Não mencionar termos técnicos como "Markdown" para o George.
